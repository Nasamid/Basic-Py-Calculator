...
text_result = tk.Text(root, height=2, width=28, font=("Arial",20))
...
btn_pa = tk.Button(root, text="(", command=lambda: add_to_calculation("("), width=5, font=("Arial",15))
btn_pa.grid(row=5, column=1)

btn_pb = tk.Button(root, text=")", command=lambda: add_to_calculation(")"), width=5, font=("Arial",15))
btn_pb.grid(row=5, column=3)
...
btn_times = tk.Button(root, text="x", command=lambda: add_to_calculation("*"), width=5, font=("Arial",15))
...
btn_equal = tk.Button(root, text="=", command=evaluate_calculation, width=10, font=("Arial",15))
btn_equal.grid(row=6, column=3, columnspan=2)

btn_dp = tk.Button(root, text=".", command=lambda: add_to_calculation("."), width=5, font=("Arial",15))
